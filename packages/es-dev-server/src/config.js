 ...
 * @property {string} [basePath] app's base path visible in the browser url. this is stripped
 *   from the request url when serving files. Should start with a / and end without a /.
